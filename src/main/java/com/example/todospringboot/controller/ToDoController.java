...
public class ToDoController {
  ...
  @PreAuthorize("hasRole('USER') or hasRole('MODERATOR') or hasRole('ADMIN')")
  public ResponseEntity<?> deleteTaskList(@PathVariable("id") int taskListId, Authentication authentication) {
      try {
    ...
    @PreAuthorize("hasRole('USER') or hasRole('MODERATOR') or hasRole('ADMIN')")
    public void updateTaskList(@PathVariable("id") int taskListId, @RequestBody TaskList taskList, Authentication authentication) {
        try {
  ...
  public ResponseEntity<List<Task>> getAllTask(Authentication authentication) {
    ...
    @PreAuthorize("hasRole('USER') or hasRole('MODERATOR') or hasRole('ADMIN')")
    public ResponseEntity<?> deleteTask(@PathVariable("id") int taskId, Authentication authentication) {
        try {
    ...
    @PreAuthorize("hasRole('USER') or hasRole('MODERATOR') or hasRole('ADMIN')")
    public void updateTask(@PathVariable("id") int taskId, @RequestBody Task task, Authentication authentication) {
        try {
  ...
  public ResponseEntity<SubTask> getSubTask(@PathVariable("id") int subTaskId) {
    ...
    @PreAuthorize("hasRole('USER') or hasRole('MODERATOR') or hasRole('ADMIN')")
    public ResponseEntity<?> deleteSubTask(@PathVariable("id") int subTaskId, Authentication authentication) {
        try {
    ...
    @PreAuthorize("hasRole('USER') or hasRole('MODERATOR') or hasRole('ADMIN')")
    public void updateSubTask(@PathVariable("id") int subTaskId, @RequestBody SubTask subTask, Authentication authentication) {
        try {
