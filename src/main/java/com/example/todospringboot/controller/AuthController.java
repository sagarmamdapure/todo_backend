...
public class AuthController {
  ...
  @PostMapping("/forget")
  public String forgetPassword(@RequestBody ForgetUserPayload forgetUser)
          throws URISyntaxException {

    return userRepositoryService.forgetPassword(forgetUser);
  }

  @PostMapping("/changepassword")
  public Boolean changePassword(@RequestBody ForgetUserPayload forgetUser) {
    return userRepositoryService.changePassword(forgetUser);
  }
}
